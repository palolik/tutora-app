...
class NotificationWidgetTeacher extends StatefulWidget {
  const NotificationWidgetTeacher({Key? key}) : super(key: key);
  @override
  _NotificationWidgetTeacherState createState() =>
      _NotificationWidgetTeacherState();
}

class _NotificationWidgetTeacherState extends State<NotificationWidgetTeacher> {
