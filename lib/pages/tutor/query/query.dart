...
class QueryTeacher extends StatefulWidget {
  QueryTeacher({Key? key}) : super(key: key);

  @override
  _QueryTeacherState createState() => _QueryTeacherState();
}

class _QueryTeacherState extends State<QueryTeacher> {
  ...
  CollectionReference students =
      FirebaseFirestore.instance.collection('queryTeacher');
