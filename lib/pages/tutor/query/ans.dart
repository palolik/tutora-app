...
class ansQueryTeacher extends StatefulWidget {
  ansQueryTeacher({Key? key}) : super(key: key);
  @override
  _ansQueryTeacherState createState() => _ansQueryTeacherState();
}

class _ansQueryTeacherState extends State<ansQueryTeacher> {
  final Stream<QuerySnapshot> studentsStream =
      FirebaseFirestore.instance.collection('queryTeacher').snapshots();
  @override
