...
class Cl6science extends StatefulWidget {
  Cl6science({Key? key}) : super(key: key);
  @override
  _Cl6scienceState createState() => _Cl6scienceState();
}

class _Cl6scienceState extends State<Cl6science> {
  String rup = "";
