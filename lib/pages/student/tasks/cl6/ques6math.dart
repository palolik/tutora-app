...
class Cl6bangla extends StatefulWidget {
  Cl6bangla({Key? key}) : super(key: key);
  @override
  _Cl6banglaState createState() => _Cl6banglaState();
}

class _Cl6banglaState extends State<Cl6bangla> {
  String rup = "";
  final String DoC = '5';
  final String CoL = 'bangla';
  int score = 0;
  late var str;
